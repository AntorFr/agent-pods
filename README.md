...
| [`agent-voice`](images/agent-voice/) | Voice satellite server: drives ESPHome `voice_assistant` devices over the native API (in HA's place), Wyoming STT/TTS, wake-word routing to the agent gateway (async ack + announce) or Home Assistant. |
